        ...
        <div className="relative border rounded-md">
            <div className="flex items-center space-x-10 p-5 bg-gray-100 text-sm text-gray-600">
                ...
                <div>
                    ...
                    <p>
                        <Currency quantity={order.amount} currency='GBP'/> - Next Day Delivery <Currency quantity={order.amountShipping} currency='GBP'/>
                    </p>
                </div>
            ...
            <div className='p-5 sm:p-10'>
                <div className='flex space-x-6 overflow-x-auto'>
                    {order.images.map(image => <img className='h-20 object-contain sm:h-32' src={image} />)}
                </div>
            </div>
        </div>
    )
